...
const HeaderMenu = dynamic(() => import('@components/layout/header/header-menu'));
// import HeaderMenu from '@components/layout/header/header-menu';
const Search = dynamic(() => import('@components/common/search'));
// import Search from '@components/common/search';
const LanguageSwitcher = dynamic(() => import('@components/ui/language-switcher'));
// import LanguageSwitcher from '@components/ui/language-switcher';
const UserIcon = dynamic(() => import('@components/icons/user-icon'));
