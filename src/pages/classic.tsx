...
const FeatureGrid = dynamic(() => import("@components/common/featured-grid"));
...
const FreshVegetablesProductFeed = dynamic(() => import("@components/product/feeds/fresh-vegetables-product-feed"));
// import CookiesProductFeed from '@components/product/feeds/cookies-product-feed';
const CookiesProductFeed = dynamic(() => import("@components/product/feeds/cookies-product-feed"));
// import PopcornJerkyProductFeed from '@components/product/feeds/popcorn-jerky-product-feed';
const PopcornJerkyProductFeed = dynamic(() => import("@components/product/feeds/popcorn-jerky-product-feed"));
// import ChipsProductFeed from '@components/product/feeds/chips-product-feed';
const ChipsProductFeed = dynamic(() => import("@components/product/feeds/chips-product-feed"));
