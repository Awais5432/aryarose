...
const Layout = dynamic(() => import("@components/layout/layout-five"));
...
const DownloadAppsTwo = dynamic(() => import("@components/common/download-apps-two"));

// import BundleGrid from '@components/bundle/bundle-grid-two';
const BundleGrid = dynamic(() => import("@components/bundle/bundle-grid-two"));

// import CollectionGrid from '@components/common/collection-grid';
const CollectionGrid = dynamic(() => import("@components/common/collection-grid"));

// import BestSellerGroceryProductFeed from '@components/product/feeds/best-seller-grocery-product-feed';
const BestSellerGroceryProductFeed = dynamic(() => import("@components/product/feeds/best-seller-grocery-product-feed"));
...
const BannerGridTwo = dynamic(() => import("@components/common/banner-grid-two"));

// import BannerHeroGrid from '@components/common/banner-hero-grid';
const BannerHeroGrid = dynamic(() => import("@components/common/banner-hero-grid"));
...
const FeatureCarousel = dynamic(() => import("@components/common/featured-carousel"));

// import PopularProductWithBestDeals from '@components/product/popular-product-with-best-deals';
const PopularProductWithBestDeals = dynamic(() => import("@components/product/popular-product-with-best-deals"));
